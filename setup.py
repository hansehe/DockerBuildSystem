...
setup(
    ...
    name='DockerBuildSystem',  # Required
    ...
    description='A Docker build system for managing docker.',  # Required
    ...
    # above.
    author_email='heh@dips.no',  # Optional
    ...
    keywords='Docker Build System',  # Optional
